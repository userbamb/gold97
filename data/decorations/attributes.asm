...
; entries correspond to deco constants
	...
	decoration DECO_POSTER,  4,         SET_UP_POSTER,     EVENT_DECO_POSTER_1,                $25
	decoration DECO_POSTER,  5,        SET_UP_POSTER,     EVENT_DECO_POSTER_2,                $26
	decoration DECO_POSTER,  6,      SET_UP_POSTER,     EVENT_DECO_POSTER_3,                $27
