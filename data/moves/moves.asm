...
; entries correspond to constants/move_constants.asm
	...
	move FIRE_PUNCH,   EFFECT_BURN_HIT,           80, FIRE,     100, 15,  10
	move ICE_PUNCH,    EFFECT_FREEZE_HIT,         80, ICE,      100, 15,  10
	move THUNDERPUNCH, EFFECT_PARALYZE_HIT,       80, ELECTRIC, 100, 15,  10
	...
	move CUT,          EFFECT_PRIORITY_HIT,       65, FLYING,   100, 30,   0
	move GUST,         EFFECT_GUST,               75, FLYING,   100, 35,   0
	move WING_ATTACK,  EFFECT_NORMAL_HIT,         80, FLYING,   100, 35,   0
	move WHIRLWIND,    EFFECT_FORCE_SWITCH,        0, NORMAL,   100, 20,   0
	move FLY,          EFFECT_FLY,               100, FLYING,    95, 15,   0
	...
	move HEADBUTT,     EFFECT_FLINCH_HIT,         70, NORMAL,   100, 15,  35
	...
	move WRAP,         EFFECT_TRAP_TARGET,        15, NORMAL,    95, 20,   0
	...
	move POISON_STING, EFFECT_POISON_HIT,         45, POISON,   100, 35,  30
	...
	move BITE,         EFFECT_FLINCH_HIT,         70, DARK,     100, 25,  35
	...
	move ACID,         EFFECT_DEFENSE_DOWN_HIT,   55, POISON,   100, 30,  40
	...
	move HYDRO_PUMP,   EFFECT_NORMAL_HIT,        110, WATER,     95, 15,   0
	move SURF,         EFFECT_CONFUSE_HIT,        95, WATER,    100, 15,  50
	move ICE_BEAM,     EFFECT_FREEZE_HIT,         95, ICE,      100, 10,  10
	move BLIZZARD,     EFFECT_FREEZE_HIT,        110, ICE,       95, 10,  20
	move PSYBEAM,      EFFECT_CONFUSE_HIT,        65, PSYCHIC,  100, 20,  20
	move BUBBLEBEAM,   EFFECT_SPEED_DOWN_HIT,     65, WATER,    100, 20, 100
	move AURORA_BEAM,  EFFECT_ATTACK_DOWN_HIT,    65, ICE,      100, 20, 100
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        150, NORMAL,    90,  5,   0
	move PECK,         EFFECT_NORMAL_HIT,         55, FLYING,   100, 35,   0
	move DRILL_PECK,   EFFECT_NORMAL_HIT,        100, FLYING,   100, 20,   0
	move SUBMISSION,   EFFECT_RECOIL_HIT,         80, FIGHTING,  80, 25,   0
	move LOW_KICK,     EFFECT_FLINCH_HIT,         50, FIGHTING,  90, 20,  35
	move COUNTER,      EFFECT_COUNTER,             1, FIGHTING, 100, 20,   0
	move SEISMIC_TOSS, EFFECT_LEVEL_DAMAGE,        1, FIGHTING, 100, 20,   0
	move STRENGTH,     EFFECT_ATTACK_UP_HIT,      80, NORMAL,   100, 15, 100
	move ABSORB,       EFFECT_LEECH_HIT,          40, GRASS,    100, 20,   0
	move MEGA_DRAIN,   EFFECT_LEECH_HIT,          65, GRASS,    100, 10,   0
	...
	move SOLARBEAM,    EFFECT_SOLARBEAM,         140, GRASS,    100, 10,   0
	...
	move THUNDER,      EFFECT_THUNDER,           110, ELECTRIC,  95, 10,  35
	move ROCK_THROW,   EFFECT_SPEED_DOWN_HIT,     65, ROCK,     100, 15, 100
	...
	move TOXIC,        EFFECT_TOXIC,               0, POISON,    95, 10,   0
	move CONFUSION,    EFFECT_CONFUSE_HIT,        50, PSYCHIC,  100, 25,  40
	move PSYCHIC_M,    EFFECT_SP_DEF_DOWN_HIT,    90, PSYCHIC,  100, 10,  30
	move HYPNOSIS,     EFFECT_SLEEP,               0, PSYCHIC,   90, 20,   0
	move MEDITATE,     EFFECT_ATTACK_UP,           0, PSYCHIC,  100, 40,   0
	move AGILITY,      EFFECT_SPEED_UP_2,          0, PSYCHIC,  100, 30,   0
	move QUICK_ATTACK, EFFECT_PRIORITY_HIT,       50, NORMAL,   100, 30,   0
	...
	move DOUBLE_TEAM,  EFFECT_EVASION_UP_2,        0, NORMAL,   100, 15,   0
	...
	move BONE_CLUB,    EFFECT_FLINCH_HIT,         65, GROUND,    85, 20,  15
	move FIRE_BLAST,   EFFECT_BURN_HIT,          110, FIRE,      95,  5,  30
	move WATERFALL,    EFFECT_FLINCH_HIT,         80, WATER,    100, 15,  30
	move CLAMP,        EFFECT_TRAP_TARGET,        35, WATER,     95, 10,   0
	...
	move CONSTRICT,    EFFECT_SPEED_DOWN_HIT,     10, NORMAL,   100, 35,  30
	...
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          50, BUG,      100, 15,   0
	...
	move BUBBLE,       EFFECT_PRIORITY_HIT,       60, WATER,    100, 30,   0
	move DIZZY_PUNCH,  EFFECT_CONFUSE_HIT,        70, NORMAL,   100, 10,  20
	move SPORE,        EFFECT_SLEEP,               0, GRASS,    100, 15,   0
	move FLASH,        EFFECT_ACCURACY_DOWN,       0, NORMAL,    90, 20,   0
	...
	move CROSS_CUTTER, EFFECT_ATTACK_UP_HIT,      50, BUG,      100, 25, 100
	move SKETCH,       EFFECT_SKETCH,              0, NORMAL,   100,  1,   0
	move TRIPLE_KICK,  EFFECT_TRIPLE_KICK,        10, FIGHTING,  90, 10,   0
	move THIEF,        EFFECT_THIEF,              80, DARK,     100, 10, 100
	...
	move POWDER_SNOW,  EFFECT_PRIORITY_HIT,       60, ICE,      100, 25,   0
	...
	move SWEET_KISS,   EFFECT_CONFUSE,             0, NORMAL,    85, 10,   0
	...
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT, 100, WATER,     95, 20, 100
	...
	move ICY_WIND,     EFFECT_SPEED_DOWN_HIT,     65, ICE,       95, 15, 100
	...
	move SPARK,        EFFECT_ATTACK_UP_HIT,      75, ELECTRIC, 100, 20, 100
	move FURY_CUTTER,  EFFECT_FURY_CUTTER,        10, BUG,       95, 20,   0
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     70, STEEL,     90, 25,  20
	...
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       85, DRAGON,   100, 20,  30
	move BATON_PASS,   EFFECT_BATON_PASS,          0, NORMAL,   100, 40,   0
	move ENCORE,       EFFECT_ENCORE,              0, NORMAL,   100,  5,   0
	move PURSUIT,      EFFECT_PURSUIT,            60, DARK,     100, 20,   0
	...
	move CRUNCH,       EFFECT_DEFENSE_DOWN_HIT,   80, DARK,     100, 15,  40
	move MIRROR_COAT,  EFFECT_MIRROR_COAT,         1, PSYCHIC,  100, 20,   0
	move PSYCH_UP,     EFFECT_PSYCH_UP,            0, NORMAL,   100, 10,   0
	move EXTREMESPEED, EFFECT_PRIORITY_HIT,       85, NORMAL,   100, 15,   0
	...
	move ROCK_SMASH,   EFFECT_ALWAYS_HIT,         70, FIGHTING, 100, 15,   0
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        15, WATER,    100, 15,   0
