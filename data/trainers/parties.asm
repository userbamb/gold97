...
FalknerGroup:
	...
	db  70, FEAROW, SHARP_BEAK, FAINT_ATTACK, DRILL_PECK, STEEL_WING, AGILITY
	db  71, MADAME, KINGS_ROCK, SWORDS_DANCE, SLASH, SKY_ATTACK, FAINT_ATTACK
	db  72, NOCTOWL, GOLD_BERRY, HYPNOSIS, REFLECT, DREAM_EATER, SKY_ATTACK
	db  73, SKARMORY, MIRACLEBERRY,  STEEL_WING, PROTECT, WHIRLWIND, DRILL_PECK
	db  72, XATU, SHARP_BEAK, CONFUSE_RAY, PSYCHIC_M, DRILL_PECK, SHADOW_BALL
	db  74, PIDGEOT, SHARP_BEAK,  PROTECT, MUD_SLAP, RAZOR_WIND, WING_ATTACK
	db -1 ; end
...
WhitneyGroup:
	...
	db 71, CLEFABLE, LEFTOVERS, PSYCHIC_M, SING, MOONLIGHT, METRONOME
	db 72, LICKILORD, BITTER_BERRY, THRASH, AMNESIA, LICK, SUPERSONIC
	db 74, WIGGLYTUFF, PINK_BOW, SWEET_KISS, SING, BODY_SLAM, REST
	db 74, SNUBBULL, PINK_BOW, SWEET_KISS, PERISH_SONG, DOUBLE_EDGE, SAFEGUARD
	db 79, BLISSEY, NO_ITEM, SOFTBOILED, LIGHT_SCREEN, SING, MINIMIZE
	db 75, MILTANK, LEFTOVERS, ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end
...
BugsyGroup:
	...
	db 73, TUHEAD, SILVERPOWDER,   PIN_MISSILE, PSYCHIC_M, SLUDGE_BOMB, SPIDER_WEB
	db 71, VENOMOTH, BRIGHTPOWDER,  SLEEP_POWDER, PSYCHIC_M, SLUDGE_BOMB, SUPERSONIC
	db 73, TRIPSTAR, GOLD_BERRY, SUPERSONIC, REFLECT, LIGHT_SCREEN, DOUBLE_EDGE
	db 72, SCIZOR, SCOPE_LENS,  SLASH, FURY_CUTTER, SWORDS_DANCE, DOUBLE_TEAM
	db 72, PARASECT, MIRACLE_SEED, SPORE, GIGA_DRAIN, GROWTH, FURY_CUTTER
	db 74, PRAXE, SCOPE_LENS, METAL_CLAW, SUBMISSION, MEGAHORN, FOCUS_ENERGY
	db -1 ; end
...
MortyGroup:
	...
	db 74, TWINZ, GOLD_BERRY, CONFUSE_RAY, PAIN_SPLIT, SHADOW_BALL, MEAN_LOOK
	db 72, PANGSHI, SPELL_TAG,  PSYBEAM, CURSE, CONFUSE_RAY, MEAN_LOOK
	db 79, GENGAR, SPELL_TAG,   NIGHT_SHADE, SHADOW_BALL, MEAN_LOOK, CONFUSE_RAY
	db 73, NINETALES, CHARCOAL,  FLAMETHROWER, SAFEGUARD, CONFUSE_RAY, FAINT_ATTACK
	db 73, PANGSHI, NO_ITEM, SHADOW_BALL, PERISH_SONG, CONFUSE_RAY, PAIN_SPLIT
	db 75, GENGAR, LEFTOVERS, HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db -1 ; end
...
PryceGroup:
	...
	db 73, DEWGONG, MINT_BERRY, SAFEGUARD, SURF, ICE_BEAM, REST
	db 74, DELIBIRD, NEVERMELTICE, BLIZZARD, HEAL_BELL, HAZE, DRILL_PECK
	db 72, CLOYSTER, LEFTOVERS,  HYDRO_PUMP, PROTECT, SPIKES, BLIZZARD
	db 73, SNEASEL, SCOPE_LENS, METAL_CLAW, ICE_PUNCH, SLASH, AGILITY
	db 74, LAPRAS, MYSTIC_WATER, SURF, ICE_BEAM, BODY_SLAM, SING
	db 77, WARWOLF,  NEVERMELTICE,  ICE_PUNCH, SLASH, SWAGGER, LOW_KICK
	db -1 ; end
...
JasmineGroup:
	...
	db 72, MAGNETON, MAGNET,  THUNDERBOLT, SUPERSONIC, LIGHT_SCREEN, THUNDER_WAVE
	db 73, METTO, MYSTERYBERRY,  TRANSFORM, NO_MOVE, NO_MOVE, NO_MOVE
	db 73, SKARMORY, BRIGHTPOWDER, PROTECT, MUD_SLAP, STEEL_WING, DRILL_PECK
	db 72, MAGNETON, MAGNET,  LIGHT_SCREEN, ZAP_CANNON, LOCK_ON, THUNDER_WAVE
	db 74, GROTESS, GOLD_BERRY, SURF, CRUNCH, IRON_TAIL, ACID_ARMOR
	db 75, STEELIX, METAL_COAT, EARTHQUAKE, SANDSTORM, ROCK_HEAD, IRON_TAIL
	db -1 ; end
...
OkeraGroup:
	...
	db 74, MURKROW, NO_ITEM,  DRILL_PECK, THIEF, STEEL_WING, DETECT
	db 73, GIRAFARIG, MIRACLEBERRY,  CONFUSE_RAY, PSYCHIC_M, PAIN_SPLIT, CRUNCH
	db 74, BELLRUN, BLACKGLASSES, GLARE, DISABLE, PURSUIT, ATTRACT
	db 75, MURKROW, GOLD_BERRY,  PERISH_SONG, FAINT_ATTACK, TOXIC, MEAN_LOOK
	db 73, MANTINE, BRIGHTPOWDER, CONFUSE_RAY, HYDRO_PUMP, WING_ATTACK, PSYBEAM
	db 79, HOUNDOOM, BLACKGLASSES,  FLAMETHROWER, CRUNCH, SWAGGER, SLUDGE_BOMB
	db -1 ; end
...
LoreleiGroup:
	...
	db 72, DEWGONG,    ICE_BEAM, SURF, REST, SAFEGUARD
	db 73, CLOYSTER,   SPIKE_CANNON, ICE_BEAM, HYDRO_PUMP, BARRIER
	db 73, JYNX,       PSYCHIC_M, LOVELY_KISS, ICE_PUNCH, BODY_SLAM
	db 73, WARWOLF,    SLASH, BLIZZARD, LOW_KICK, CONFUSE_RAY
	db 74, LAPRAS,     BODY_SLAM, BLIZZARD, SURF, PSYCHIC_M
	db -1 ; end
	
	db "LORELEI@", TRAINERTYPE_ITEM_MOVES
	db 94, DEWGONG, MINT_BERRY, ICE_BEAM, SURF, REST, SAFEGUARD
	db 95, CLOYSTER, LEFTOVERS, SPIKE_CANNON, ICE_BEAM, HYDRO_PUMP, BARRIER
	db 95, JYNX, TWISTEDSPOON,  PSYCHIC_M, LOVELY_KISS, ICE_PUNCH, BODY_SLAM
	db 94, AQUARIUS, MYSTERYBERRY,  HYDRO_PUMP, ICE_BEAM, BODY_SLAM, SAFEGUARD
	db 95, WARWOLF, NEVERMELTICE,    SLASH, BLIZZARD, LOW_KICK, CONFUSE_RAY
	db 97, LAPRAS, NEVERMELTICE,  BODY_SLAM, BLIZZARD, SURF, PSYCHIC_M
	db -1 ; end
...
AgathaGroup:
	...
	db 75, GENGAR,   HYPNOSIS, SHADOW_BALL, DESTINY_BOND, THUNDERPUNCH
	db 74, ARBOK,    CRUNCH, GLARE, SLUDGE_BOMB, DIG
	db 74, PANGSHI,   PAIN_SPLIT, SHADOW_BALL, REFLECT, PERISH_SONG
	db 76, MAROWAK,  DOUBLE_EDGE, BONEMERANG, ANCIENTPOWER, IRON_TAIL
	db 77, GENGAR,   SHADOW_BALL, ICE_PUNCH, PSYCHIC_M, DESTINY_BOND
	db -1 ; end
	
	db "AGATHA@", TRAINERTYPE_ITEM_MOVES
	db 87, GENGAR, MAGNET,  HYPNOSIS, SHADOW_BALL, DESTINY_BOND, THUNDERPUNCH
	db 86, ARBOK, POISON_BARB,   CRUNCH, GLARE, SLUDGE_BOMB, DIG
	db 86, PANGSHI, SPELL_TAG,   PAIN_SPLIT, SHADOW_BALL, REFLECT, PERISH_SONG
	db 84, BELLRUN, MIRACLEBERRY,  PURSUIT, SLASH, GLARE, ATTRACT
	db 88, MAROWAK, METAL_COAT,  DOUBLE_EDGE, BONEMERANG, ANCIENTPOWER, IRON_TAIL
	db 89, GENGAR, NEVERMELTICE,  SHADOW_BALL, ICE_PUNCH, PSYCHIC_M, DESTINY_BOND
	db -1 ; end

GiovanniE4Group:
	; GIOVANNI_E4 (1)
	db "GIOVANNI@", TRAINERTYPE_MOVES
	db 76, PERSIAN,    FAINT_ATTACK, SLASH, MUD_SLAP, THUNDERBOLT
	db 76, NIDOQUEEN,  SUBMISSION, BODY_SLAM, SLUDGE_BOMB, ICE_BEAM
	db 78, KANGASKHAN, DIZZY_PUNCH, ATTRACT, CRUNCH, FIRE_BLAST
	db 78, NIDOKING,   MEGAHORN, EARTHQUAKE, SLUDGE_BOMB, HYPER_BEAM
	db 82, RHYDON,     ROCK_SLIDE, DOUBLE_EDGE, EARTHQUAKE, SURF
	db -1 ; end
	
	db "GIOVANNI@", TRAINERTYPE_ITEM_MOVES
	db 96, PERSIAN, SCOPE_LENS,   FAINT_ATTACK, SLASH, MUD_SLAP, THUNDERBOLT
	db 96, NIDOQUEEN, POISON_BARB,  SUBMISSION, BODY_SLAM, SLUDGE_BOMB, ICE_BEAM
	db 98, KANGASKHAN, LEFTOVERS, DIZZY_PUNCH, ATTRACT, CRUNCH, FIRE_BLAST
	db 97, DUGTRIO, SOFT_SAND, EARTHQUAKE, FISSURE, TRI_ATTACK, SAND_ATTACK
	db 98, NIDOKING, BERSERK_GENE,  MEGAHORN, EARTHQUAKE, SLUDGE_BOMB, HYPER_BEAM
	db 92, RHYDON, HARD_STONE, ROCK_SLIDE, DOUBLE_EDGE, EARTHQUAKE, SURF
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 72, TUHEAD,    DOUBLE_TEAM, PIN_MISSILE, TOXIC, PSYCHIC_M
	db 73, CROBAT,     DOUBLE_TEAM, CONFUSE_RAY, FLY, TOXIC
	db 75, VENOMOTH,   SLEEP_POWDER, GIGA_DRAIN, PSYCHIC_M, TOXIC
	db 74, WEEZING,    SLUDGE_BOMB, FLAMETHROWER, DESTINY_BOND, TOXIC
	db 76, MUK,        EARTHQUAKE, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db -1 ; end
...
ChampionGroup:
	...
	db 79, GYARADOS,   EARTHQUAKE, RAIN_DANCE, SURF, HYPER_BEAM
	db 80, DRAGONITE,  THUNDER_WAVE, WING_ATTACK, THUNDER, HYPER_BEAM
	db 80, DRAGONITE,  THUNDER_WAVE, DRAGONBREATH, BLIZZARD, HYPER_BEAM
	db 82, AERODACTYL, WING_ATTACK, EARTHQUAKE, ROCK_SLIDE, HYPER_BEAM
	db 82, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
	db 85, DRAGONITE,  FIRE_BLAST, SAFEGUARD, OUTRAGE, HYPER_BEAM
	db -1 ; end
	
	db "LANCE@", TRAINERTYPE_ITEM_MOVES
	db 89, GYARADOS, MYSTIC_WATER,  EARTHQUAKE, RAIN_DANCE, SURF, HYPER_BEAM
	db 90, DRAGONITE, MAGNET,   THUNDER_WAVE, WING_ATTACK, THUNDER, HYPER_BEAM
	db 90, DRAGONITE, NEVERMELTICE,  THUNDER_WAVE, DRAGONBREATH, BLIZZARD, HYPER_BEAM
	db 92, AERODACTYL, HARD_STONE, WING_ATTACK, EARTHQUAKE, ROCK_SLIDE, HYPER_BEAM
	db 92, CHARIZARD, SCOPE_LENS,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
	db 99, DRAGONITE, BITTER_BERRY,  FIRE_BLAST, SAFEGUARD, OUTRAGE, HYPER_BEAM
	db -1 ; end
...
RedGroup:
	...
	db 92, PIKACHU, LIGHT_BALL, CHARM, THUNDER_WAVE, THUNDERBOLT, DOUBLE_TEAM
	db 91, ESPEON, TWISTEDSPOON,  MUD_SLAP, REFLECT, MORNING_SUN, PSYCHIC_M
	db 94, SNORLAX, MIRACLEBERRY,  AMNESIA, SNORE, REST, BODY_SLAM
	db 90, VENUSAUR, LEFTOVERS,   SUNNY_DAY, SLUDGE_BOMB, SYNTHESIS, SOLARBEAM
	db 90, CHARIZARD, KINGS_ROCK,  FLAMETHROWER, WING_ATTACK, SLASH, FIRE_SPIN
	db 90, BLASTOISE, BRIGHTPOWDER,  RAIN_DANCE, SURF, BLIZZARD, PROTECT
	db -1 ; end
