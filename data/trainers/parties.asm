...
FalknerGroup:
	...
	db  90, FEAROW, SHARP_BEAK, FAINT_ATTACK, DRILL_PECK, STEEL_WING, AGILITY
	db  91, MADAME, KINGS_ROCK, SWORDS_DANCE, SLASH, SKY_ATTACK, FAINT_ATTACK
	db  92, NOCTOWL, GOLD_BERRY, HYPNOSIS, REFLECT, DREAM_EATER, SKY_ATTACK
	db  93, SKARMORY, MIRACLEBERRY,  STEEL_WING, PROTECT, WHIRLWIND, DRILL_PECK
	db  92, XATU, SHARP_BEAK, CONFUSE_RAY, PSYCHIC_M, DRILL_PECK, SHADOW_BALL
	db  94, PIDGEOT, SHARP_BEAK,  PROTECT, MUD_SLAP, RAZOR_WIND, WING_ATTACK
	db -1 ; end
...
WhitneyGroup:
	...
	db 91, CLEFABLE, LEFTOVERS, PSYCHIC_M, SING, MOONLIGHT, METRONOME
	db 92, LICKILORD, BITTER_BERRY, THRASH, AMNESIA, LICK, SUPERSONIC
	db 94, WIGGLYTUFF, PINK_BOW, SWEET_KISS, SING, BODY_SLAM, REST
	db 94, SNUBBULL, PINK_BOW, SWEET_KISS, PERISH_SONG, DOUBLE_EDGE, SAFEGUARD
	db 99, BLISSEY, NO_ITEM, SOFTBOILED, LIGHT_SCREEN, SING, MINIMIZE
	db 95, MILTANK, LEFTOVERS, ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end
...
BugsyGroup:
	...
	db 93, TUHEAD, SILVERPOWDER,   PIN_MISSILE, PSYCHIC_M, SLUDGE_BOMB, SPIDER_WEB
	db 91, VENOMOTH, BRIGHTPOWDER,  SLEEP_POWDER, PSYCHIC_M, SLUDGE_BOMB, SUPERSONIC
	db 93, TRIPSTAR, GOLD_BERRY, SUPERSONIC, REFLECT, LIGHT_SCREEN, DOUBLE_EDGE
	db 92, SCIZOR, SCOPE_LENS,  SLASH, FURY_CUTTER, SWORDS_DANCE, DOUBLE_TEAM
	db 92, PARASECT, MIRACLE_SEED, SPORE, GIGA_DRAIN, GROWTH, FURY_CUTTER
	db 94, PRAXE, SCOPE_LENS, METAL_CLAW, SUBMISSION, MEGAHORN, FOCUS_ENERGY
	db -1 ; end
...
MortyGroup:
	...
	db 94, TWINZ, GOLD_BERRY, CONFUSE_RAY, PAIN_SPLIT, SHADOW_BALL, MEAN_LOOK
	db 92, PANGSHI, SPELL_TAG,  PSYBEAM, CURSE, CONFUSE_RAY, MEAN_LOOK
	db 99, GENGAR, SPELL_TAG,   NIGHT_SHADE, SHADOW_BALL, MEAN_LOOK, CONFUSE_RAY
	db 93, NINETALES, CHARCOAL,  FLAMETHROWER, SAFEGUARD, CONFUSE_RAY, FAINT_ATTACK
	db 93, PANGSHI, NO_ITEM, SHADOW_BALL, PERISH_SONG, CONFUSE_RAY, PAIN_SPLIT
	db 95, GENGAR, LEFTOVERS, HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db -1 ; end
...
PryceGroup:
	...
	db 93, DEWGONG, MINT_BERRY, SAFEGUARD, SURF, ICE_BEAM, REST
	db 94, DELIBIRD, NEVERMELTICE, BLIZZARD, HEAL_BELL, HAZE, DRILL_PECK
	db 92, CLOYSTER, LEFTOVERS,  HYDRO_PUMP, PROTECT, SPIKES, BLIZZARD
	db 93, SNEASEL, SCOPE_LENS, METAL_CLAW, ICE_PUNCH, SLASH, AGILITY
	db 94, LAPRAS, MYSTIC_WATER, SURF, ICE_BEAM, BODY_SLAM, SING
	db 97, WARWOLF,  NEVERMELTICE,  ICE_PUNCH, SLASH, SWAGGER, LOW_KICK
	db -1 ; end
...
JasmineGroup:
	...
	db 92, MAGNETON, MAGNET,  THUNDERBOLT, SUPERSONIC, LIGHT_SCREEN, THUNDER_WAVE
	db 93, METTO, MYSTERYBERRY,  TRANSFORM, NO_MOVE, NO_MOVE, NO_MOVE
	db 93, SKARMORY, BRIGHTPOWDER, PROTECT, MUD_SLAP, STEEL_WING, DRILL_PECK
	db 92, MAGNETON, MAGNET,  LIGHT_SCREEN, ZAP_CANNON, LOCK_ON, THUNDER_WAVE
	db 94, GROTESS, GOLD_BERRY, SURF, CRUNCH, IRON_TAIL, ACID_ARMOR
	db 95, STEELIX, METAL_COAT, EARTHQUAKE, SANDSTORM, ROCK_HEAD, IRON_TAIL
	db -1 ; end
...
OkeraGroup:
	...
	db 94, MURKROW, NO_ITEM,  DRILL_PECK, THIEF, STEEL_WING, DETECT
	db 93, GIRAFARIG, MIRACLEBERRY,  CONFUSE_RAY, PSYCHIC_M, PAIN_SPLIT, CRUNCH
	db 94, BELLRUN, BLACKGLASSES, GLARE, DISABLE, PURSUIT, ATTRACT
	db 95, MURKROW, GOLD_BERRY,  PERISH_SONG, FAINT_ATTACK, TOXIC, MEAN_LOOK
	db 93, MANTINE, BRIGHTPOWDER, CONFUSE_RAY, HYDRO_PUMP, WING_ATTACK, PSYBEAM
	db 99, HOUNDOOM, BLACKGLASSES,  FLAMETHROWER, CRUNCH, SWAGGER, SLUDGE_BOMB
	db -1 ; end
